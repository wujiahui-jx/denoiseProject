...
if __name__ == '__main__':
   ...
   #    layer.trainable = False
    ...
    #history = model.fit(x_train_1,y_train_1,batch_size=32,epochs=10,validation_data=(x_test_1,y_test_1))
    #model.save('my_model.h5')

    history = new_model.fit(x_train_1,y_train_2,batch_size=16,epochs=1,validation_data=(x_test_1,y_test_2))
